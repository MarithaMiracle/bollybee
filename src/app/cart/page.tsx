    ...
    <div className="mx-auto max-w-7xl px-4 py-10 md:px-8 md:py-16">
      ...
      <div className="grid gap-10 lg:grid-cols-[1fr_360px]">
        <ul className="divide-y divide-[var(--border)]">
          {items.map((item) => (
            <li key={item.variationId} className="flex gap-4 py-6">
              ...
              <div className="flex flex-1 flex-col justify-between">
                <div>
                  <Link href={`/product/${item.slug}`} className="font-display text-lg hover:text-[var(--plum)]">
                    {item.productName}
                  </Link>
              ...
              <button
                ...
                className="self-start text-xs text-[var(--muted)] hover:text-[var(--destructive)]"
