  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="mx-auto max-w-3xl px-4 py-12 md:px-8 md:py-20">
        ...
        <article className="brand-panel-xl space-y-12 bg-[var(--background)]/94 p-6 shadow-sm backdrop-blur-md sm:p-8 md:p-12">
          <header className="text-center">
            <p className="text-[10px] uppercase tracking-[0.3em] text-[var(--muted)]">Our Story</p>
            <h1 className="mt-4 font-display text-3xl sm:text-4xl md:text-5xl">About Bollybee</h1>
          </header>
          ...
          <div className="space-y-4 text-sm leading-relaxed text-[var(--muted-foreground)] md:text-base">
            <p>
              ...
              self-expression. We believe every person deserves to feel luxurious and empowered, and it starts with a fragrance that lingers beautifully.
            </p>
            <p>
          ...
          <div>
            <h2 className="font-display text-2xl sm:text-3xl">Our Mission</h2>
          ...
          <div>
            <h2 className="font-display text-2xl sm:text-3xl">Why Choose Us</h2>
